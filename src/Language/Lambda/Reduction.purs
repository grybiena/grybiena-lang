...
reduce = hyloM catamorphism anamorphism
  where
    catamorphism :: AlgebraM m (LambdaF var cat) (f (LambdaF var cat))
    catamorphism =
      case _ of
        Var v -> pure $ var v
    ...
    anamorphism :: CoalgebraM m (LambdaF var cat) (f (LambdaF var cat))
    anamorphism l =
      case project l of
        Var v -> pure $ Var v
        Abs x e -> do
