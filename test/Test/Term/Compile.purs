...
import Language.Lambda.Judgement (class Reasoning, Judgement)
...
compileTestSuite :: Effect Unit
compileTestSuite = do
  let dir = "fixtures/term/compile"
  ls <- readdir dir
...
testCompileTerm nm v t = test nm do
  RWSResult _ res _ <- (runUnificationT $ compiles v t)
  case res of
